...
def print_second_metric(pkl_path, gt_file='/media/faegheh/DATA/Datasets/Charades-Dataset/charades.json'):
    classes = 157

    with open(pkl_path, 'rb') as prediction_file:
        logits = pickle.load(prediction_file)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-pkl_path', type=str, default='./save_logit_rgb_flow_best_1/9.pkl')  # './test.pkl'
    # parser.add_argument('')
    ...
    gt_file = '/media/faegheh/DATA/Datasets/Charades-Dataset/charades.json'
    classes = 157
